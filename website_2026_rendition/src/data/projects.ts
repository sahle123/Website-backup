...
export const projects: Project[] = [
  {
    ...
    team: ['Sahle Alturaigi (Programmer)', 'Junior physician + 2 supporting members'],
    launch: { label: 'Play on itch.io', url: 'https://itch.io/jam/gamers8-gameathon-game-jam-2022/rate/1675647' },
  },
  {
    slug: 'afterlife',
    title: 'AfterLife',
    category: 'Unity · First-Person Platformer',
    tagline: 'A Zelda- and Dark Souls-inspired soul hunt, beatable in 15 minutes.',
    card: afterlifeCard,
  ...
  },
  {
    ...
    description: [
      ...
      'The build leans heavily on Photon Unity Networking (PUN) for its real-time multiplayer layer. It\'s an alpha proof-of-concept — a benchmark for what we could pull off before polish and balance passes — rather than a finished product, and there are no current plans to develop it further.',
      'Launch it below to play with friends.',
    ],
    technologies: ['Unity', 'C#', 'JavaScript', 'Photon (PUN)', 'Mixamo', 'Fuse', 'HTML5'],
    team: ['Akmal Idris', 'Sahle Alturaigi'],
    launch: { label: 'Launch demo', url: 'http://akmalhisyam.com/demo/WrinkleWrumble/' },
  },
  {
    slug: 'social-circuit',
